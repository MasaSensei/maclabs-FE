            ...
            <div className="text-sm max-w-full">
              <article className="mb-1.5 p-6 rounded-lg bg-white shadow">
                ...
                <div className="text-lg pt-3 text-slate-800">
                  <p className="my-5">
                    Mac dan MacBook sudah dilengkapi dengan OS X atau macOS yang
                    terkenal memiliki sistem yang stabil dan jarang mengalami
                    masalah. Ada kalanya Mac dan MacBook mengalami masalah
                    sehingga harus diperbaiki   Memperbaiki Mac sendiri memang
                    masih bisa dilakukan sendiri dalam beberapa kasus. Salah
                    satunya adalah dengan melakukan reset SMC Mac. Melakukan
                    reset SMC ini bisa kamu coba untuk menyelesaikan masalah Mac
                  ...
                  <p className="my-5">
                    ...
                    berputar kencang padahal tidak menjalankan tugas berat, Mac
                    tidak merespon ketika tombol power ditekan hingga random
                    shuts down.
                  </p>
                  ...
                  <ul className="list-decimal list-inside">
                    <li>
                      Matikan Mac terlebih dahulu lewat logo Apple di pojok kiri
                      atas lalu Shut Down
                    </li>
                  ...
                  <ul className="list-decimal list-inside">
                    ...
                    <li>
                      Setelah Mac mati, tekan Shift-Control-Option pada keyboard
                      sebelah kiri lalu tekan tombol Power.
                    </li>
                    <li>
                  ...
                  <ul className="list-decimal list-inside">
                    ...
                    <li>Lepaskan kabel power yang terhubung ke Mac Desktop.</li>
                  ...
                  <p className="my-5">
                    ...
                    kalian mengalami masalah, kalian dapat berkonsultasi secara
                    gratis ke{" "}
                    <Link href="/" className="text-red-500 uppercase font-bold">
                      Maclabs.co.id
                    </Link>{" "}
